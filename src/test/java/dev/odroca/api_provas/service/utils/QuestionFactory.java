...
public class QuestionFactory {
    ...
    public static Set<QuestionEntity> buildQuestionEntityWithoutOptionCorrectNoSentQuestion(TestEntity test) {
        Set<QuestionEntity> questions = new HashSet<>();
        ...
        Set<OptionEntity> options1 = OptionFactory.buildOptionsEntity(question1, "2", true, "3", false, "4", false); // Nenhuma correta
        Set<OptionEntity> options2 = OptionFactory.buildOptionsEntity(question1, "2", false, "3", true, "4", false);
        Set<OptionEntity> options3 = OptionFactory.buildOptionsEntity(question1, "2", false, "3", false, "4", false);
